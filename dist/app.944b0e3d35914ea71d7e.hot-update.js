...
/* harmony import */ var _store_StoreComponent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../store/StoreComponent */ "./src/store/StoreComponent.js");
var _marked =
/*#__PURE__*/
...
function axiosSaga() {
  console.log(_store_StoreComponent__WEBPACK_IMPORTED_MODULE_2__["store"].getState().clientSignUpReducer.form);
  return axios__WEBPACK_IMPORTED_MODULE_1___default()({
    method: 'post',
    url: '/request/signup',
    data: {
      email: _store_StoreComponent__WEBPACK_IMPORTED_MODULE_2__["store"].getState().clientSignUpReducer.form.email,
      password: _store_StoreComponent__WEBPACK_IMPORTED_MODULE_2__["store"].getState().clientSignUpReducer.form.password,
      terms: _store_StoreComponent__WEBPACK_IMPORTED_MODULE_2__["store"].getState().clientSignUpReducer.form.terms
    }
...
//# sourceMappingURL=app.944b0e3d35914ea71d7e.hot-update.js.map