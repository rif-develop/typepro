...
_store_StoreComponent__WEBPACK_IMPORTED_MODULE_24__["sagaMiddleware"].run(_sagas__WEBPACK_IMPORTED_MODULE_8__["default"]);
/*상태 변화시 마다 log 출력*/

_store_StoreComponent__WEBPACK_IMPORTED_MODULE_24__["store"].subscribe(function (e) {
  console.log(_store_StoreComponent__WEBPACK_IMPORTED_MODULE_24__["store"].getState());
});
/*IE버젼 체커*/
...
window.addEventListener('resize', function () {
  _store_StoreComponent__WEBPACK_IMPORTED_MODULE_24__["store"].dispatch({
...
if (ieVersion < LauchableVersion.ie) {
  ...
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_5__["Provider"], {
    store: _store_StoreComponent__WEBPACK_IMPORTED_MODULE_24__["store"]
...
/*!*************************************!*\
  !*** ./src/store/StoreComponent.js ***!
  \*************************************/
/*! exports provided: sagaMiddleware, store */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
