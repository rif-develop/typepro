    ...
    render(){
        return(
            <section className={cx(styles['main-section'],'section')}>
                        ...
                        <div className="inner">
                            <div className="centered">
                                ...
                                <div className="main-section--content--text">
                                    <div className="main-section--content--text__upper">
                                        <h1 className="__kr">육아의 다음 레벨, 리틀원</h1>
                                    </div>
                                    <div className="main-section--content--text__lower">
                                        <p>힘든 육아 우리가 도울게요.</p>
                                        <p>소중한 아이를 안전하고 영리하게 돌보세요.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="main-section--svg-container">
                    <svg width="532" height="513" viewBox="0 0 532 513" id="violet">
                        <defs>
                    ...
                    <svg width="532" height="513" viewBox="0 0 532 513" id="purple">
                        <defs>
                    ...
                    <svg width="577" height="577" viewBox="0 0 577 577" id="green">
                        <defs>
