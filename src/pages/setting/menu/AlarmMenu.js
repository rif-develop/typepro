        ...
        return (
            <ul className={styles['web-setting-section--container--options--list']}>
                <DefaultOptionComponent name={'그룹원 활동'}
                                        ...
                                        switchToggle={memberActivityAlarm}
