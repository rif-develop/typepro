...
class RegisterAddressComponent extends React.Component {
    ...
    componentDidMount() {
        window.addEventListener('scroll touchmove mousewheel', this.onScrollingHandler);
    ...
    componentWillUnmount() {
        window.removeEventListener('scroll touchmove mousewheel', this.onScrollingHandler);
    }
            ...
            <div className={styles['delivery-add-modal']} data-modal-name="delivery-add" ref={this.modal}>
                ...
                <form id="delivery-add-form" className={styles['delivery-add-modal--form']} role="form">
                    ...
                    <div className={styles['delivery-add-modal--form--submit']}>
                        <button type="reset" className={styles['__cancel-delivery-button']} data-join-modal="delivery-add">취소</button>
                        <button type="submit" className={styles['__add-delivery-button']} data-join-modal="delivery-add">확인</button>
                    </div>
                </form>
                <button type="button" className={styles['__close-modal-form']} data-join-modal="delivery-add">close</button>
            </div>
        )
    }
}
